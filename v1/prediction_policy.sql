...
CREATE TABLE `policy` (
  ...
  `policy_expiration_date` varchar(255) DEFAULT NULL,
  `policy_number` varchar(255) DEFAULT NULL,
  `predicted_result` varchar(255) DEFAULT NULL,
  `premium_amount` int DEFAULT NULL,
  `result` varchar(255) DEFAULT NULL,
  `uwscore` int DEFAULT NULL,
...
-- Dump completed on 2022-10-14 19:23:40
